...
export default function Nav() {
  ...
  return (
    <Navbar className="mx-auto min-w-full  bg-black bg-opacity-85  py-2 px-4 lg:px-8 lg:py-4">
    ...
    <div className="  flex items-center gap-1 text-gray-100 text-lg text-center cursor-pointer" onClick={()=> router.push(`/${a}/create`)}>
